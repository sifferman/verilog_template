...
synth/icestorm_icebreaker/build/icebreaker.asc: synth/icestorm_icebreaker/build/synth.json synth/icestorm_icebreaker/nextpnr.sdc synth/icestorm_icebreaker/nextpnr.pcf
	nextpnr-ice40 \
